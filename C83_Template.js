var images = ["https://i.postimg.cc/MKdhy06Z/family.jpg","https://i.postimg.cc/L6HcYQM0/grand-father.png", "https://i.postimg.cc/wjMnFtMX/father.jpg" , "https://i.postimg.cc/bw5W5zSK/mother.jpg", "https://i.postimg.cc/5ymDKL83/bro.jpg"];

var names = ["Family Book","rammana - Grandfather", "sharanabasappa pagadekal - Father", "rashmi - Mother", "gagandeep - Brother"];
...
function update()
{
    ...
    */
    ...
    var max_number = Math.age.apply(Math, );
    console.log("The highest age is: ",max_number  );
    ...
    */
    ...
    var min_number = Math.age .apply(Math,  );
    console.log("The lowest age is: ",min_number  );
}